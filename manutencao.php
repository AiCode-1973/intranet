...
// Processar abertura de chamado de manutenÃ§Ã£o
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['acao']) && $_POST['acao'] == 'abrir_manutencao') {
    ...
    if ($stmt->execute()) {
        $mensagem = "Chamado de manutenÃ§Ã£o aberto com sucesso! A equipe de infraestrutura jÃ¡ foi notificada.";
        $tipo_mensagem = "success";
        registrarLog($conn, "Abriu chamado de ManutenÃ§Ã£o: " . $titulo);
    } else {
...
// Buscar chamados de manutenÃ§Ã£o
...
$status_styles = [
    ...
    'Aguardando PeÃ§a' => ['bg' => 'bg-purple-100', 'text' => 'text-purple-600', 'dot' => 'bg-purple-500', 'icon' => 'package'],
...
<head>
    ...
    <title>Infraestrutura & ManutenÃ§Ã£o - APAS Intranet</title>
...
<body class="bg-background text-text font-sans selection:bg-primary/20">
        ...
        <div class="mb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
                <h1 class="text-xl font-bold text-primary flex items-center gap-2">
                    ...
                    ManutenÃ§Ã£o & Infraestrutura
                </h1>
                <p class="text-text-secondary text-xs mt-1">Reparos prediais, elÃ©tricos e hidrÃ¡ulicos</p>
            </div>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-background/50 border-b border-border">
                            <th class="p-3 text-[10px] font-black text-text-secondary uppercase tracking-widest">OS / DescriÃ§Ã£o</th>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="5" class="p-16 text-center">
                                    ...
                                    <p class="text-xs font-bold text-text-secondary">Nenhuma ordem de serviÃ§o encontrada.</p>
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
    ...
    <div id="modalManutencao" class="modal">
        <div class="bg-white w-full max-w-md mx-4 rounded-xl shadow-2xl border border-border overflow-hidden animate-in zoom-in duration-150">
            <div class="bg-orange-600 px-5 py-4 text-white flex justify-between items-center">
                <div>
                    <h2 class="text-base font-bold">Nova Ordem de ServiÃ§o</h2>
            ...
            <form method="POST" action="" class="p-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div class="md:col-span-2">
                        <label class="block text-[10px] font-black text-text-secondary mb-1 uppercase tracking-widest">Assunto / DescriÃ§Ã£o Curta</label>
                        <input type="text" name="titulo" required placeholder="Ex: LÃ¢mpada queimada, Vazamento..." 
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="local" required placeholder="Ex: Sala 02, RecepÃ§Ã£o, Banheiro 1Âº andar" 
                               class="w-full p-2 bg-background border border-border rounded-lg text-xs font-bold focus:outline-none focus:border-orange-600 transition-all">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <select name="categoria" class="w-full p-2 bg-background border border-border rounded-lg text-xs font-bold focus:outline-none focus:border-orange-600 transition-all cursor-pointer">
                            ...
                            <option value="MobiliÃ¡rio">MobiliÃ¡rio</option>
                    ...
                    <div class="md:col-span-2">
                        <label class="block text-[10px] font-black text-text-secondary mb-1 uppercase tracking-widest">Detalhes da OcorrÃªncia</label>
                        <textarea name="descricao" required rows="4" placeholder="Descreva com detalhes o que estÃ¡ acontecendo..."
    ...
    <!-- Modal Detalhes da Ordem de ServiÃ§o -->
    <div id="modalDetalhes" class="modal">
        <div class="bg-white w-full max-w-md mx-4 rounded-xl shadow-2xl border border-border overflow-hidden animate-in zoom-in duration-150">
            ...
            <div class="p-5 space-y-4">
                <div>
                    <label class="block text-[10px] font-black text-text-secondary mb-1 uppercase tracking-widest opacity-50">Assunto / Local</label>
                    <p id="detalhe_titulo" class="text-sm font-bold text-text">---</p>
                    <p id="detalhe_local" class="text-[11px] text-orange-600 font-bold uppercase">---</p>
                </div>

                <div>
                    <label class="block text-[10px] font-black text-text-secondary mb-1 uppercase tracking-widest opacity-50">DescriÃ§Ã£o da OcorrÃªncia</label>
                ...
                <div class="grid grid-cols-2 gap-4 pt-2 border-t border-border">
                    <div>
                        <label class="block text-[10px] font-black text-text-secondary mb-0.5 uppercase tracking-widest opacity-50">Equipe ResponsÃ¡vel</label>
    ...
    <script>
        ...
        function verDetalhes(chamado) {
            ...
            document.getElementById('detalhe_local').textContent = chamado.local;
