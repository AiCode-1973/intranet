    ...
    <div id="modalDetalhes" class="modal">
        <div class="bg-white w-full max-w-md mx-4 rounded-xl shadow-2xl border border-border overflow-hidden animate-in zoom-in duration-150">
            ...
            <div class="p-5 space-y-4">
                ...
                <div>
                    <label class="block text-[10px] font-black text-text-secondary mb-1 uppercase tracking-widest opacity-50">Descrição da Ocorrência</label>
                ...
                <div class="grid grid-cols-2 gap-4 pt-2 border-t border-border">
                    <div>
                        <label class="block text-[10px] font-black text-text-secondary mb-0.5 uppercase tracking-widest opacity-50">Equipe Responsável</label>
