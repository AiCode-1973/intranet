...
async def run_test():
    ...
    try:
        ...
        # -> Try a second login attempt: replace CPF with unformatted '00000000000', enter password 'admin123', and click 'Entrar no Sistema' to see if login succeeds or returns a different error.
        frame = context.pages[-1]
        # Input text
        elem = frame.locator('xpath=html/body/div/div[2]/div/form/div[1]/div/input').nth(0)
